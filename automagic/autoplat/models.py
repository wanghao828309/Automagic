...
class Element(models.Model):
    ...
    locmode = models.CharField(max_length=32, choices=Element_Choice, null=True, blank=False, editable=True,default="id")
    location = models.CharField(max_length=400, null=True, blank=True, editable=True)
    createtime = models.DateTimeField(auto_now_add=True)
    createat = models.CharField(max_length=32, null=True, blank=True, editable=True)
    updatetime = models.DateTimeField(auto_now=True)
    updateat = models.CharField(max_length=32, null=True, blank=True, editable=True)
...
class Case(models.Model):
    ...
    jiraid = models.CharField(max_length=24, null=True, blank=True, editable=True)
...
class Task(models.Model):
    ...
    updatetime = models.DateTimeField(auto_now=True)
    updateat = models.CharField(max_length=32, null=True, blank=True, editable=True)
    jen_task_id = models.CharField(max_length=32, null=True, blank=True, editable=True)
